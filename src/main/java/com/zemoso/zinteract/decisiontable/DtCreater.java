...
public class DtCreater {
	...
	public DecisionTable createDtModel() {
		...
		List<DtRow> dtRows = new ArrayList<DtRow>();
		for (int i = 0; i < rows.size(); i++) {
			...
			if (scripts != null) {
				for (int j = 0; j < scripts.size(); j++) {
					...
					row.setScripts(scriptName, new DtScript(script));
				}
			}
			...
			for (int k = 0; k < acs.size(); k++) {
				...
				for (JsonElement action : actions) {
					if (action.getAsJsonObject().get("action").getAsString().equals(acName)) {
						dtAction.setType(action.getAsJsonObject().has("type")
				...
				// String fg = "{\"name\":\" The table to decide\",\"description\":\"
				// blah, blah
				// ,,,,,....\",\"artifact_id\":235,\"options\":[{\"propname\":\"exit_on_first_match\",\"propvalue\":\"true\"}],\"headers\":{\"conditions\":[{\"condition\":\"purchase\"},{\"condition\":\"puchase_quantity\"}],\"actions\":[{\"action\":\"Segment\"}]},\"rows\":[{\"conditions\":[{\"value\":\">=1\"},{\"value\":\">=0\"}],\"actions\":[{\"value\":\"purchase_in_last_year\"}]},{\"conditions\":[{\"value\":\">=1\"},{\"value\":\">=30\"}],\"actions\":[{\"value\":\"big_purchaser\"}]}]}"
			}
			dtRows.add(row);
		}
		dT.setDT(dtRows);
	...
	private GenericCondition createGenericCondition(String condName, String cValue, StringConstants dataType,
	...
	private DtCondition getCondition(String conValue, String dataType, String condName) {
		...
		if (m.find()) {
			...
			if (group1 != null && group2 != null) {
				return createGenericCondition(condName, group2, StringConstants.DATATYPE_LONG,
						StringConstants.COMPARATOR_GREATERTHAN);
			}
		}
		...
		if (m.find()) {
			...
			if (group1 != null && group2 != null) {
				return createGenericCondition(condName, group2, StringConstants.DATATYPE_LONG,
						StringConstants.COMPARATOR_LESSTHAN);
			}
		}
		...
		if (m.find()) {
			...
			if (group1 != null && group2 != null) {
				return createGenericCondition(condName, group2, StringConstants.DATATYPE_LONG,
						StringConstants.COMPARATOR_EQUALS);
			}
		}
		...
		if (m.find()) {
			...
			if (group1 != null && group2 != null) {
				return createGenericCondition(condName, group2, StringConstants.DATATYPE_LONG,
						StringConstants.COMPARATOR_NOT_EQUALS);
			}
		}
		...
		if (m.find()) {
			...
			if (group1 != null && group2 != null) {
				return createGenericCondition(condName, group2, StringConstants.DATATYPE_LONG,
						StringConstants.COMPARATOR_LESSTHAN_EQUALS);
			}
		}
		...
		if (m.find()) {
			...
			String group2 = m.group(3);
			if (group1 != null && group2 != null) {
				return createGenericCondition(condName, group2, StringConstants.DATATYPE_DOUBLE,
						StringConstants.COMPARATOR_GREATERTHAN);
			}
		}
		...
		if (m.find()) {
			...
			if (group1 != null && group2 != null) {
				return createGenericCondition(condName, group2, StringConstants.DATATYPE_DOUBLE,
						StringConstants.COMPARATOR_GREATERTHAN_EQUALS);
			}
		}
		...
		if (m.find()) {
			...
			if (group1 != null && m.group(3) != null && m.group(5) != null && m.group(7) != null) {
				...
				GenericCondition lessT = createGenericCondition(condName, m.group(7), StringConstants.DATATYPE_LONG,
						StringConstants.COMPARATOR_LESSTHAN);

				GenericCondition greatT = createGenericCondition(condName, m.group(3), StringConstants.DATATYPE_LONG,
						StringConstants.COMPARATOR_GREATERTHAN);
		...
		if (m.find()) {
			...
			if (group1 != null && m.group(3) != null && m.group(5) != null && m.group(7) != null) {
				BetweenCondition bCondition = new BetweenCondition();
				GenericCondition lessT = createGenericCondition(condName, m.group(7), StringConstants.DATATYPE_DOUBLE,
						StringConstants.COMPARATOR_LESSTHAN);

				GenericCondition greatT = createGenericCondition(condName, m.group(3), StringConstants.DATATYPE_DOUBLE,
						StringConstants.COMPARATOR_GREATERTHAN);
		...
		if (m.find()) {
			...
			if (group1 != null && group2 != null) {
				...
				for (String s : longs) {
					finalCondition = createGenericCondition(condName, s, StringConstants.DATATYPE_LONG,
							StringConstants.COMPARATOR_EQUALS);
		...
		if (m.find()) {
			...
			if (group1 != null && group2 != null) {
				...
				List<GenericCondition> list = new ArrayList<GenericCondition>();
				for (String s : longs) {
					finalCondition = createGenericCondition(condName, s, StringConstants.DATATYPE_DOUBLE,
							StringConstants.COMPARATOR_EQUALS);
					list.add(finalCondition);
				}
				inCondition.setComparatorName(StringConstants.COMPARATOR_IN);
		...
		if (m.find()) {
			...
			String group2 = m.group(3);
			if (group1 != null && group2 != null) {
				return createGenericCondition(condName, group2, StringConstants.DATATYPE_STRING,
						StringConstants.COMPARATOR_NOT_EQUALS);
			}
		}
		...
		if (m.find()) {
			...
			if (group1 != null && group2 != null) {
				...
				List<GenericCondition> list = new ArrayList<GenericCondition>();
				for (String s : longs) {
					finalCondition = createGenericCondition(condName, s, StringConstants.DATATYPE_STRING,
							StringConstants.COMPARATOR_EQUALS);
					list.add(finalCondition);
				}
				inCondition.setComparatorName(StringConstants.COMPARATOR_IN);
		...
		if (m.find()) {
			...
			String group2 = m.group(3);
			if (group1 != null && group2 != null) {
				return createGenericCondition(condName, group2, StringConstants.DATATYPE_BOOLEAN,
						StringConstants.COMPARATOR_EQUALS);
			}
		}
		...
		if (m.find()) {
			...
			if (group1 != null && group2 != null) {
				return createGenericCondition(condName, group2, StringConstants.DATATYPE_STRING,
						StringConstants.COMPARATOR_NOT_LIKE);
			}
		}
		...
		if (m.find()) {
			...
			if (group1 != null && group2 != null) {
				return createGenericCondition(condName, group2, StringConstants.DATATYPE_STRING,
						StringConstants.COMPARATOR_LIKE);
			}
		}
