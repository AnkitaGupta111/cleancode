...
public class DecisionTableCreater {
	...
	private DecisionTableCondition getCondition(String conValue, String dataType, String condName) {
		...
		if (m.find()) {
			...
			if (group1 != null && group2 != null) {
				return createGenericCondition(condName, group2, StringConstants.DATATYPE_LONG,
						StringConstants.COMPARATOR_GREATER_THAN);
			}
		}
		...
		if (m.find()) {
			...
			if (group1 != null && group2 != null) {
				return createGenericCondition(condName, group2, StringConstants.DATATYPE_LONG,
						StringConstants.COMPARATOR_LESS_THAN);
			}
		}
		...
		if (m.find()) {
			...
			if (group1 != null && group2 != null) {
				return createGenericCondition(condName, group2, StringConstants.DATATYPE_LONG,
						StringConstants.COMPARATOR_LESS_THAN_EQUALS);
			}
		}
		...
		if (m.find()) {
			...
			if (group1 != null && group2 != null) {
				return createGenericCondition(condName, group2, StringConstants.DATATYPE_DOUBLE,
						StringConstants.COMPARATOR_GREATER_THAN_EQUALS);
			}
		}
		...
		if (m.find()) {
			...
			if (group1 != null && group2 != null && m.group(5) != null) {
				...
				inCondition.setComparatorName(StringConstants.COMPARATOR_NOT_IN);
				inCondition.setConditionName(condName);
				inCondition.setDataType(StringConstants.DATATYPE_LONG);
				inCondition.setConditionValue(list);
				return inCondition;
