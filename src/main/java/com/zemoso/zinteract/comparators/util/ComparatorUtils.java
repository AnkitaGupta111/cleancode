...
public class ComparatorUtils {
    ...
    public static Boolean isEqual(DecisionTableCondition condition, ConditionValue rhs, boolean ignoreCase){
    ...
    public static Boolean isLike(DecisionTableCondition condition, ConditionValue rhs, boolean ignoreCase){
        GenericCondition eCondition = (GenericCondition) condition;
        if(condition.getDataType() == StringConstants.DATATYPE_STRING){
            if(ignoreCase){
    ...
    public static Boolean isNotLike(DecisionTableCondition condition, ConditionValue rhs, boolean ignoreCase){
        GenericCondition eCondition = (GenericCondition) condition;
        if(condition.getDataType() == StringConstants.DATATYPE_STRING){
            if(ignoreCase){
                return !Pattern.compile(Pattern.quote(eCondition.getConditionValue().getStringConditionValue()), Pattern.CASE_INSENSITIVE).matcher(rhs.getStringConditionValue()).find();
    ...
    public static Boolean isGreaterThan(DecisionTableCondition condition, ConditionValue rhs){
    ...
    public static Boolean isLessThan(DecisionTableCondition condition, ConditionValue rhs){
        GenericCondition greaterThanCondition = (GenericCondition) condition;
